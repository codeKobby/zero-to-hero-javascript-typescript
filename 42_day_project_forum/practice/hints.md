# Day 42 hints: Day 42: Project — Discussion Forum

Use these hints only after attempting the numbered exercises in [the lesson](../42_day_project_forum.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 42: Project — Discussion Forum**, not to copy a finished file.
