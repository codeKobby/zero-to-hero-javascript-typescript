# Day 37 hints: Day 37: TypeScript Generics — One Function, Many Types

Use these hints only after attempting the numbered exercises in [the lesson](../37_day_ts_generics.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 37: TypeScript Generics — One Function, Many Types**, not to copy a finished file.
