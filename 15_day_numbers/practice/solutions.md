# Day 15 solution guide: Day 15: Numbers and Math — Parsing, Precision, and Calculation

Use this guide only after attempting the numbered exercises in [the lesson](../15_day_numbers.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
