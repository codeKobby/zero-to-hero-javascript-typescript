# Day 24 hints: Day 24: Selecting DOM Elements — Querying the Page

Use these hints only after attempting the numbered exercises in [the lesson](../24_day_dom_selection.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 24: Selecting DOM Elements — Querying the Page**, not to copy a finished file.
