# Day 25 hints: Day 25: Changing DOM Elements — Updating the Page

Use these hints only after attempting the numbered exercises in [the lesson](../25_day_dom_manipulation.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 25: Changing DOM Elements — Updating the Page**, not to copy a finished file.
