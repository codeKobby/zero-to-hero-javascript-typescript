# Day 31 solution guide: Day 31: Promises — One Future Result

Use this guide only after attempting the numbered exercises in [the lesson](../31_day_promises_i.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
