# Day 31 hints: Day 31: Promises — One Future Result

Use these hints only after attempting the numbered exercises in [the lesson](../31_day_promises_i.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 31: Promises — One Future Result**, not to copy a finished file.
