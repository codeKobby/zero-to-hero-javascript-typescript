# Day 12 solution guide: Day 12: Higher-Order Functions I — map, filter, reduce, and forEach

Use this guide only after attempting the numbered exercises in [the lesson](../12_day_hof_i.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
