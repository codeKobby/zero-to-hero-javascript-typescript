# Day 12 hints: Day 12: Higher-Order Functions I — map, filter, reduce, and forEach

Use these hints only after attempting the numbered exercises in [the lesson](../12_day_hof_i.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 12: Higher-Order Functions I — map, filter, reduce, and forEach**, not to copy a finished file.
