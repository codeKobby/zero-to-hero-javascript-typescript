# Day 35 solution guide: Day 35: API Integration — One Boundary Owns HTTP Details

Use this guide only after attempting the numbered exercises in [the lesson](../35_day_api_integration.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
