# Day 17 solution guide: Day 17: Regular Expressions — Patterns as Tools

Use this guide only after attempting the numbered exercises in [the lesson](../17_day_regex.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
