# Day 17 hints: Day 17: Regular Expressions — Patterns as Tools

Use these hints only after attempting the numbered exercises in [the lesson](../17_day_regex.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 17: Regular Expressions — Patterns as Tools**, not to copy a finished file.
