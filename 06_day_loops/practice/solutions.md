# Day 6 solution guide: Day 6: Loops — Repeating Work with for and while

Use this guide only after attempting the numbered exercises in [the lesson](../06_day_loops.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
