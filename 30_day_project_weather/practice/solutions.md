# Day 30 solution guide: Day 30: The Weather Project — Fetching and Rendering

Use this guide only after attempting the numbered exercises in [the lesson](../30_day_project_weather.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
