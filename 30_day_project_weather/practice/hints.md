# Day 30 hints: Day 30: The Weather Project — Fetching and Rendering

Use these hints only after attempting the numbered exercises in [the lesson](../30_day_project_weather.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 30: The Weather Project — Fetching and Rendering**, not to copy a finished file.
