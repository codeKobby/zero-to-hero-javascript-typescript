# Day 33 hints: Day 33: Async and Await — Promise Syntax That Reads Sequentially

Use these hints only after attempting the numbered exercises in [the lesson](../33_day_async_await.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 33: Async and Await — Promise Syntax That Reads Sequentially**, not to copy a finished file.
