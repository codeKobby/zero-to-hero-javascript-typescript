...
Use this guide only after attempting the numbered exercises in [the lesson](../33_day_async_await.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
