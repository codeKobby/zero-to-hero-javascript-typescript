# Day 23 hints: Day 23: Web Storage — Keeping Data Between Visits

Use these hints only after attempting the numbered exercises in [the lesson](../23_day_web_storage.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 23: Web Storage — Keeping Data Between Visits**, not to copy a finished file.
