# Day 9 hints: Day 9: Objects — Related Data and Methods

Use these hints only after attempting the numbered exercises in [the lesson](../09_day_objects.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 9: Objects — Related Data and Methods**, not to copy a finished file.
