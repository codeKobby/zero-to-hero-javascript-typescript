# Day 8 solution guide: Day 8: Functions II — Function Values, Callbacks, and Closures

Use this guide only after attempting the numbered exercises in [the lesson](../08_day_functions_ii.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
