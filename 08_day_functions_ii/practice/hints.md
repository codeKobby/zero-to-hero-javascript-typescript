# Day 8 hints: Day 8: Functions II — Function Values, Callbacks, and Closures

Use these hints only after attempting the numbered exercises in [the lesson](../08_day_functions_ii.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 8: Functions II — Function Values, Callbacks, and Closures**, not to copy a finished file.
