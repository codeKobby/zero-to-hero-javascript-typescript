# Day 7 solution guide: Day 7: Functions I — Inputs, Work, and Results

Use this guide only after attempting the numbered exercises in [the lesson](../07_day_functions_i.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
