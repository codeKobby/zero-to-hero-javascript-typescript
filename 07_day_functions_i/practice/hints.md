# Day 7 hints: Day 7: Functions I — Inputs, Work, and Results

Use these hints only after attempting the numbered exercises in [the lesson](../07_day_functions_i.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 7: Functions I — Inputs, Work, and Results**, not to copy a finished file.
