# Day 29 solution guide: Day 29: The Todo Project — Bringing It Together

Use this guide only after attempting the numbered exercises in [the lesson](../29_day_project_todo.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
