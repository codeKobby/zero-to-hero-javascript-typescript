...
Use these hints only after attempting the numbered exercises in [the lesson](../29_day_project_todo.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 29: The Todo Project — Bringing It Together**, not to copy a finished file.
