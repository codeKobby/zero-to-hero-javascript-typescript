# Day 20 solution guide: Day 20: Designing Classes — Contracts and Data Hiding

Use this guide only after attempting the numbered exercises in [the lesson](../20_day_classes_ii.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
