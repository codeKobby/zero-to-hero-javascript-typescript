# Day 20 hints: Day 20: Designing Classes — Contracts and Data Hiding

Use these hints only after attempting the numbered exercises in [the lesson](../20_day_classes_ii.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 20: Designing Classes — Contracts and Data Hiding**, not to copy a finished file.
