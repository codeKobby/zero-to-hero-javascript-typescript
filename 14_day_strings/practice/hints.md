# Day 14 hints: Day 14: Strings — Text as a Value

Use these hints only after attempting the numbered exercises in [the lesson](../14_day_strings.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 14: Strings — Text as a Value**, not to copy a finished file.
