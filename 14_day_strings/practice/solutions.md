# Day 14 solution guide: Day 14: Strings — Text as a Value

Use this guide only after attempting the numbered exercises in [the lesson](../14_day_strings.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
