...
Use these hints only after attempting the numbered exercises in [the lesson](../05_day_control_flow.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
