# Day 19 solution guide: Day 19: Classes and Instances — Blueprints and Objects

Use this guide only after attempting the numbered exercises in [the lesson](../19_day_classes_i.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
