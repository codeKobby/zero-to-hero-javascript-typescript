# Day 19 hints: Day 19: Classes and Instances — Blueprints and Objects

Use these hints only after attempting the numbered exercises in [the lesson](../19_day_classes_i.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 19: Classes and Instances — Blueprints and Objects**, not to copy a finished file.
