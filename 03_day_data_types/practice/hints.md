# Day 3 hints: Day 3: Data Types — What a Value Is, and How to Ask

Use these hints only after attempting the numbered exercises in [the lesson](../03_day_data_types.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 3: Data Types — What a Value Is, and How to Ask**, not to copy a finished file.
