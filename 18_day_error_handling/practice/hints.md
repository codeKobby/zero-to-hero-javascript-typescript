# Day 18 hints: Day 18: Errors and Recovery — Failing on Purpose

Use these hints only after attempting the numbered exercises in [the lesson](../18_day_error_handling.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 18: Errors and Recovery — Failing on Purpose**, not to copy a finished file.
