# Day 32 hints: Day 32: Coordinating Promises — Waiting for Many Results

Use these hints only after attempting the numbered exercises in [the lesson](../32_day_promises_ii.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 32: Coordinating Promises — Waiting for Many Results**, not to copy a finished file.
