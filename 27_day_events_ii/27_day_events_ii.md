...
[← Previous lesson](../26_day_events_i/26_day_events_i.md) · [README](../README.md) · [Setup](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../28_day_functional_programming/28_day_functional_programming.md)
