# Day 27 hints: Day 27: Event Delegation and Forms — One Listener, Many Elements

Use these hints only after attempting the numbered exercises in [the lesson](../27_day_events_ii.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 27: Event Delegation and Forms — One Listener, Many Elements**, not to copy a finished file.
