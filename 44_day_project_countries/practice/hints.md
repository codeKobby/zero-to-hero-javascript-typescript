# Day 44 hints: Day 44: Project — Country Explorer

Use these hints only after attempting the numbered exercises in [the lesson](../44_day_project_countries.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 44: Project — Country Explorer**, not to copy a finished file.
