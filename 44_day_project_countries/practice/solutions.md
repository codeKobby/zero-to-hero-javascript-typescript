# Day 44 solution guide: Day 44: Project — Country Explorer

Use this guide only after attempting the numbered exercises in [the lesson](../44_day_project_countries.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
