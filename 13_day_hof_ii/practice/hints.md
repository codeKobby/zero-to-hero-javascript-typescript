# Day 13 hints: Day 13: Higher-Order Functions II — Array Questions and Safe Sorting

Use these hints only after attempting the numbered exercises in [the lesson](../13_day_hof_ii.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 13: Higher-Order Functions II — Array Questions and Safe Sorting**, not to copy a finished file.
