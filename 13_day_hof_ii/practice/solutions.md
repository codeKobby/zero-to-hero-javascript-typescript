# Day 13 solution guide: Day 13: Higher-Order Functions II — Array Questions and Safe Sorting

Use this guide only after attempting the numbered exercises in [the lesson](../13_day_hof_ii.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
