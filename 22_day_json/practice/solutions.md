# Day 22 solution guide: Day 22: JSON and External Data — Shaping Untrusted Input

Use this guide only after attempting the numbered exercises in [the lesson](../22_day_json.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
