# Day 22 hints: Day 22: JSON and External Data — Shaping Untrusted Input

Use these hints only after attempting the numbered exercises in [the lesson](../22_day_json.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 22: JSON and External Data — Shaping Untrusted Input**, not to copy a finished file.
