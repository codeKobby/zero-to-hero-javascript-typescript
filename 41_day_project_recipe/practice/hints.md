# Day 41 hints: Day 41: Project — Recipe Book

Use these hints only after attempting the numbered exercises in [the lesson](../41_day_project_recipe.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 41: Project — Recipe Book**, not to copy a finished file.
