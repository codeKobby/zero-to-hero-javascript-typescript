# Day 36 hints: Day 36: TypeScript Types and Interfaces — Designing the Data Contract

Use these hints only after attempting the numbered exercises in [the lesson](../36_day_ts_types.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 36: TypeScript Types and Interfaces — Designing the Data Contract**, not to copy a finished file.
