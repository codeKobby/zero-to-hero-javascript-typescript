# Day 21 hints: Day 21: Modules — Imports and Exports

Use these hints only after attempting the numbered exercises in [the lesson](../21_day_modules.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 21: Modules — Imports and Exports**, not to copy a finished file.
