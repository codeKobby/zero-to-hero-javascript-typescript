# Day 21 solution guide: Day 21: Modules — Imports and Exports

Use this guide only after attempting the numbered exercises in [the lesson](../21_day_modules.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
