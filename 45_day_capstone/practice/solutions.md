# Day 45 solution guide: Day 45: Capstone — Build and Defend Your Own Application

Use this guide only after attempting the numbered exercises in [the lesson](../45_day_capstone.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
