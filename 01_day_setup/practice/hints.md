# Day 1 hints: Day 1: How Programs Run — the Machine Model, Node, and Your First Code

Use these hints only after attempting the numbered exercises in [the lesson](../01_day_setup.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 1: How Programs Run — the Machine Model, Node, and Your First Code**, not to copy a finished file.
