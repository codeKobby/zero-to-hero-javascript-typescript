# Day 2 solution guide: Day 2: Variables — Names, Values, and the Rules of Change

Use this guide only after attempting the numbered exercises in [the lesson](../02_day_variables.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
