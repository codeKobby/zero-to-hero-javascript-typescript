# Day 2 hints: Day 2: Variables — Names, Values, and the Rules of Change

Use these hints only after attempting the numbered exercises in [the lesson](../02_day_variables.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 2: Variables — Names, Values, and the Rules of Change**, not to copy a finished file.
