# Day 26 solution guide: Day 26: Events — Responding to the User

Use this guide only after attempting the numbered exercises in [the lesson](../26_day_events_i.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
