# Day 26 hints: Day 26: Events — Responding to the User

Use these hints only after attempting the numbered exercises in [the lesson](../26_day_events_i.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 26: Events — Responding to the User**, not to copy a finished file.
