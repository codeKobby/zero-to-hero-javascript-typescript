# Day 28 exercises: Day 28: Functional Programming — Composing Small Pure Functions

Read the [lesson](../28_day_functional_programming.md) first. Before coding, open the [course README](../../README.md), confirm the [setup guide](../../VS_CODE_SETUP.md), and choose the correct Node, TypeScript, or browser workflow. Work locally with synthetic data.
...
1. Define the main idea in **Day 28: Functional Programming — Composing Small Pure Functions** in two sentences for a complete beginner and point to the first example that demonstrates it.
