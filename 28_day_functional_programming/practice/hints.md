# Day 28 hints: Day 28: Functional Programming — Composing Small Pure Functions

Use these hints only after attempting the numbered exercises in [the lesson](../28_day_functional_programming.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 28: Functional Programming — Composing Small Pure Functions**, not to copy a finished file.
