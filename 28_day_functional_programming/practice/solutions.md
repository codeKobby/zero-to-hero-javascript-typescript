# Day 28 solution guide: Day 28: Functional Programming — Composing Small Pure Functions

Use this guide only after attempting the numbered exercises in [the lesson](../28_day_functional_programming.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
