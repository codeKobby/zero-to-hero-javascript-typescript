# Day 38 hints: Day 38: TypeScript Utility Types — Transforming Shapes Without Rewriting Them

Use these hints only after attempting the numbered exercises in [the lesson](../38_day_ts_utility_types.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 38: TypeScript Utility Types — Transforming Shapes Without Rewriting Them**, not to copy a finished file.
