...
[← Previous lesson](../38_day_ts_utility_types/38_day_ts_utility_types.md) · [README](../README.md) · [Setup](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../40_day_ts_best_practices/40_day_ts_best_practices.md)
