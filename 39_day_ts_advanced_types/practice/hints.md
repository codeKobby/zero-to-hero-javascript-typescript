# Day 39 hints: Day 39: TypeScript Advanced Types — Conditional and Mapped Types

Use these hints only after attempting the numbered exercises in [the lesson](../39_day_ts_advanced_types.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 39: TypeScript Advanced Types — Conditional and Mapped Types**, not to copy a finished file.
