# Day 39 solution guide: Day 39: TypeScript Advanced Types — Conditional and Mapped Types

Use this guide only after attempting the numbered exercises in [the lesson](../39_day_ts_advanced_types.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
