# Day 43 hints: Day 43: Project — E-commerce Product List

Use these hints only after attempting the numbered exercises in [the lesson](../43_day_project_ecommerce.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 43: Project — E-commerce Product List**, not to copy a finished file.
