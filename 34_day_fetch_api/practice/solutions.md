...
Use this guide only after attempting the numbered exercises in [the lesson](../34_day_fetch_api.md). It contains review checkpoints rather than a copied submission. A strong answer explains the decision, the runtime behavior, the TypeScript boundary, and the limitation.
