# Day 34 hints: Day 34: Fetch — Talking to a Server

Use these hints only after attempting the numbered exercises in [the lesson](../34_day_fetch_api.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 34: Fetch — Talking to a Server**, not to copy a finished file.
