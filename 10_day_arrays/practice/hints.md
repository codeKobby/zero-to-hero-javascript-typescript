# Day 10 hints: Day 10: Arrays — Ordered Collections and Array Methods

Use these hints only after attempting the numbered exercises in [the lesson](../10_day_arrays.md). If your environment is the problem, read the [course README](../../README.md), [VS Code setup](../../VS_CODE_SETUP.md), and [troubleshooting guide](../../TROUBLESHOOTING.md) before changing code.
...
The goal is to understand **Day 10: Arrays — Ordered Collections and Array Methods**, not to copy a finished file.
